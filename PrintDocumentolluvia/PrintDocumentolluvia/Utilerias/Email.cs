...
namespace PrintDocumentolluvia.Utilerias
{
    public class Email
    {
        ...
        private static void EnviarCorreoExternoUsuario(string asunto, string cuerpo, string emailUSuario, string file, string correoCopia)
        {
            try
            {
                string correoProveedor = ConfigurationManager.AppSettings["correoProveedor"].ToString();//"cristian.perez.garcia.54@gmail.com";
                string contrasenaProveedor = ConfigurationManager.AppSettings["contrasenaProveedor"].ToString(); //ConfigurationManager.AppSettings["contrasenaCorreoExterno"].ToString(); //"Kaneki_54";
