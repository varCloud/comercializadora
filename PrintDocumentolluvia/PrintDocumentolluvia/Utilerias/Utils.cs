...
namespace lluviaBackEnd.Utilerias
{
    public static class Utils
    {
            ...
            try
            {
                ...
                html4 += @"
                    ...
                    <tr> 
                     ...
                     <tr> 
                     <td colspan='9' style='text-align:right' >" + PrintDocumentolluvia.Utilerias.lluviaBackEnd.Utilerias.Moneda.Convertir(c.Total.ToString(), true) + @"</td>
                    </tr>
                    <tr>
                        <td  width='10%'></td>
                        <td  width='10%'></td>
        ...
        public static string ObtnerFolderCodigos()
        {
            ...
            try
            {
                ruta = ConfigurationManager.AppSettings["pathPdfCodigos"].ToString();
                DateTime fecha = System.DateTime.Now;
        ...
        public static string ObtnerFolderTickets()
        {
            ...
            try
            {
                ruta = ConfigurationManager.AppSettings["pathPdfTickets"].ToString();
                //DateTime fecha = System.DateTime.Now;
                    ...
                    <tr>
                        <td width='35%'>
                            <table width='100%' height='100%'   style='font-size:6.8px;font-family:Arial;color:7b7b7b;'" + @"  CELLPADDING='0' >
                                <tr>
                                    <td><img src='"+ System.AppDomain.CurrentDomain.BaseDirectory.ToString() + "\\assets\\img\\logo_lluvia_150.jpg" + @"' width = '78' height = '63' align='center' /></td>
                                </tr>                                
                  ...
                  @"<table  width='100%'>
                    <tr>
                        <td width='35%'>
                            <table width='100%' height='100%'   style='font-size:6.8px;font-family:Arial;color:7b7b7b;'" + @"  CELLPADDING='0' >
                                <tr>
                                    <td><img src='"  + "\\assets\\img\\logo_lluvia_150.jpg" + @"' width = '78' height = '63' align='center' /></td>
                                </tr>                                
