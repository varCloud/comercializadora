...
-- se crea procedimiento SP_CONSULTA_PROVEEDORES
if exists (select * from sysobjects where name like 'SP_CONSULTA_PROVEEDORES' and xtype = 'p' and db_name() = 'DB_A552FA_comercializadora')
	drop proc SP_CONSULTA_PROVEEDORES
go
...
create proc SP_CONSULTA_PROVEEDORES
...
grant exec on SP_CONSULTA_PROVEEDORES to public
go
