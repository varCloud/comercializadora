        ...
        void pd_PrintPageTicketOriginal(object sender, PrintPageEventArgs e, Notificacion<dynamic> ticket)
        {
            try
            {
                ...
                if (paginaActual == 0)
                {
                    ...
                    e.Graphics.DrawString("Ticket:" + ticket.Modelo[0].idPedidoEspecial.ToString(), font, drawBrush, 40, 181, izquierda);
        ...
        void pd_PrintPageDevoluciones(object sender, PrintPageEventArgs e, Notificacion<dynamic> ticketDevolucion)
        {
            ...
            try
            {
                ...
                if (paginaActual == 0)
                {
                    ...
                    e.Graphics.DrawString("Ticket:" + ticketDevolucion.Modelo[0].idPedidoEspecial.ToString(), font, drawBrush, 40, 181, izquierda);
