...
$('#btnReenviarPE').click(function () {
    ...
    $.ajax({
        ...
        data: { idPedidoEspecial: idPedidoEspecial, idVenta: 0 , correoAdicional: correo, idUsuario: idUsuarioGlobal },
        method: 'post',
        dataType: 'json',
        async: true,
        beforeSend: function (xhr) {
...
function ConsultaDetalleFactura(idPedidoEspecial) {
    ...
    var result = '';
    $.ajax({
        url: rootUrl("/FacturaPedidosEspeciales/ObtenerDetalleFacturaPE"),
