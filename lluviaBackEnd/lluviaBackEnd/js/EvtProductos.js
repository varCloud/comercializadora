...
function onSuccessResultProductos(data, notificacion) {
    console.log("onSuccessResult", JSON.stringify(data), JSON.stringify(notificacion)  );
...
function ObtenerProducto(idProducto) {
    ...
    $.ajax({
        ...
        data: { idProducto: idProducto, fechaAlta: null },
        method: 'post',
        dataType: 'json',
        async: false,
        beforeSend: function (xhr) {
